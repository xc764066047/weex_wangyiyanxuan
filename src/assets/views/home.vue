<template>
    <div class="wrapper">
        ...
        <scroller :class="['main-list', isIpx&&isIpx()?'ml-ipx':'']" offset-accuracy="1000" loadmoreoffset="1000" @loadmore="onloadmore">
            ...
            <!-- loading组件提供了上拉加载的功能,但在这里并没有什么卵用，因为前面用到了懒加载 -->
    ...
    export default {
        ...
        data () {
            return {
                ...
                goodsList:[],
                showLoading: 'hide'     // 平时上拉加载的loading组件是被隐藏的
            }
        },
        ...
        methods: {
            ...
            // 下拉sroller列表懒加载触发的方法
            onloadmore () {
                modal.toast({ message: 'onloadmore', duration: 1 })
                setTimeout(() => {
                    this.goodsList.push(...this.recommend.goods1);
                }, 100)
            },
